...
export const mockPersonalNews: PersonalNewsState = {
  ...
  currentScript: {
    ...
    chapters: [
      ...
      { id: 'chapter_002', title: '02 AndroidとPC環境', lineIndex: 1, positionMs: 22_000 },
      { id: 'chapter_003', title: '03 ゲームと海の話', lineIndex: 2, positionMs: 43_000 },
    ],
    lines: [
      { id: 'line_001', kind: 'text', topic: '01 AIコーディング', text: 'きりたんメモです。AIコーディング系は便利さの裏側に、実行権限まわりの怖さも見えてきました。 知らないリポジトリをAIに読ませる時は、読むだけ・実行しない、の境界をちゃんと作りたいところですね。', durationMs: 22_000, sourceId: null, positionMs: 0 },
      { id: 'line_002', kind: 'text', topic: '02 AndroidとPC環境', text: 'Android 17のベータ周りは、壁紙やWebView系の検証にもじわっと関係してきそうです。 PCファーストで作って、段階的に実機へ持っていく方針はまだかなり相性がよさそうです。', durationMs: 21_000, sourceId: null, positionMs: 22_000 },
      { id: 'line_003', kind: 'text', topic: '03 ゲームと海の話', text: 'Switch 2や海事ニュースも、作業の横で流れてくると地味に楽しいやつです。 以上、歌詞がない曲の余白からお送りする、きりたん式の興味ニュースでした。', durationMs: 17_000, sourceId: null, positionMs: 43_000 },
    ],
    supplements: [
      { id: 'supplement_001', title: '01 AIコーディング / Agentic coding security report', text: 'Agentic coding security report', url: 'https://example.com/ai-coding-security', lineIndex: 0, chapterIndex: 0, positionMs: 10_000, durationMs: 6_000 },
      { id: 'supplement_002', title: '02 AndroidとPC環境 / Android Developers latest updates', text: 'Android Developers latest updates', url: 'https://developer.android.com/latest-updates', lineIndex: 1, chapterIndex: 1, positionMs: 32_000, durationMs: 6_000 },
    ],
    sources: [
      { id: 'source_001', title: 'Agentic coding security report', url: 'https://example.com/ai-coding-security', lineIndex: 0, chapterIndex: 0, positionMs: 10_000 },
      { id: 'source_002', title: 'Android Developers latest updates', url: 'https://developer.android.com/latest-updates', lineIndex: 1, chapterIndex: 1, positionMs: 32_000 },
    ],
    estimatedDurationMs: 60_000,
    modifiedAt: new Date().toISOString(),
  },
